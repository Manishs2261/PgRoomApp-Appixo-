    ...
    try {
      ...
      try {
        DocumentReference docRef = await FirebaseFirestore.instance
            .collection(
                "${AppEnvironment.environmentName}_${CollectionName.services}")
            .add(item.toJson())
  ...
  static Future<String> uploadImageToFirebase(File imageFile, docId) async {
    try {
      final reference = FirebaseStorage.instance.ref().child(
          '${AppEnvironment.environmentName}_${CollectionName.services}/${user.uid}/$docId/${DateTime.now().millisecondsSinceEpoch}.jpg');
