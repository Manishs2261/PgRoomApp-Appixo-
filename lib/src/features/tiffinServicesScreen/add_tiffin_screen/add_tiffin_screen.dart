...
import 'package:pgroom/src/features/tiffinServicesScreen/add_tiffin_screen/controller/controller.dart';
...
class AddTiffineScreen extends StatelessWidget {
  const AddTiffineScreen({super.key});
  ...
  Widget build(BuildContext context) {
   ...
   final controller = Get.put(AddYourTiffineController());
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Choose your  Cover Image"),
      ),
