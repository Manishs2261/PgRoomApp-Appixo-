...
class FirstRoomUpdateFormScreen extends StatelessWidget {
  final controller = Get.put(FirstRoomUpdateFormController());
  final List<String> bhkOptions = [
   ...
   FirstRoomUpdateFormScreen({super.key});

  @override
  Widget build(BuildContext context) {
    AppLoggerHelper.debug(
        "Build - FirstRoomUpdateFormScreen......................................");
    return Scaffold(
      appBar: AppBar(
        title: Text( 'Update Details',style: TextStyle(fontWeight: FontWeight.w400),),
                    ...
                    child: ListView.builder(
                      ...
                      :  Container(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount:
                          controller.roomModel.imageList?.length ?? 0,
                            ...
                            return Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  width: Get.width * 0.8,
                                  imageUrl: controller
                                      .roomModel.imageList?[imageIndex] ??
                                      '',
