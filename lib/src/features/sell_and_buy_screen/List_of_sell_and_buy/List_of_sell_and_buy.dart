        ...
        () =>
            listOfSellAndBuyController.isLoadingInitial.value
                ...
                : CustomMaterialIndicator(
                  ...
                  child:
                      listOfSellAndBuyController.sellAndBuyModel.isEmpty &&
                              !listOfSellAndBuyController.isLoadingInitial.value
                          ? Center(
                            child: Text(
                          ...
                          : ListView.builder(
                            controller:
                                listOfSellAndBuyController.scrollController,
                            itemCount:
...
class SellAndBuyListCardWidgets extends StatelessWidget {
  const SellAndBuyListCardWidgets({super.key, required this.buyAndSellModel});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap:
          () => Get.toNamed(
            RoutesName.sellAndBuyDetails,
            arguments: buyAndSellModel,
          ),
      child: Container(
                      ...
                      return Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            width: Get.width * 0.8,
                            imageUrl: buyAndSellModel.image?[imageIndex] ?? '',
                            placeholder:
