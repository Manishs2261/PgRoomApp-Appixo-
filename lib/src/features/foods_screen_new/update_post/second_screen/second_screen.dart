...
import '../first_screen/controller/controller.dart';
import 'controller/controller.dart';

class SecondFoodUpdateForm extends StatelessWidget {
  SecondFoodUpdateForm({super.key});

  final controller = Get.put(SecondFoodUpdateFormController());
  final firstFoodFormController = Get.put(FirstFoodUpdateFormController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(
        title: Text('Update Menu',style: TextStyle(fontWeight: FontWeight.w400),),
      ),
