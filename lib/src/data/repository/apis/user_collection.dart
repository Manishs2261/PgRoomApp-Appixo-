...
class UserApis {
  ...
  static Future<void> getUserData() async {
    var collection = firebaseFirestore
        .collection('${AppEnvironment.environmentName}_${CollectionName.user}')
        .doc(user.uid);
  ...
  static Future<void> updateUserImage(File file) async {
    ...
    final ref = storage.ref().child(
        '${AppEnvironment.environmentName}_${CollectionName.user}/${user.uid}.$ext');
...
//============== Share preference =========================
  ...
  static Future<String> uploadUserImage(File imageFile) async {
    try {
      final reference = storage.ref().child(
          '${AppEnvironment.environmentName}_${CollectionName.user}/${user.uid}.jpg');
  ...
  static Future<List<UserModel>> getUserDataList() async {
    try {
      ...
      var collection = firebaseFirestore.collection(
          '${AppEnvironment.environmentName}_${CollectionName.user}');
  ...
  static Future<void> updateCityName(String cityName) async {
    ...
    try {
      await FirebaseFirestore.instance
        ...
        AppLoggerHelper.info("update successfully with ID: $userDocId");
