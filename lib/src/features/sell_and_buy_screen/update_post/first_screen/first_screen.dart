...
class SellAndBuyUpdateForm extends StatelessWidget {
  SellAndBuyUpdateForm({super.key});

  final controller = Get.put(SellAndBuyUpdateController());

  @override
  Widget build(BuildContext context) {
    AppLoggerHelper.debug(
        "Build - SellAndBuyUpdateForm ......................................");
    return Scaffold(
      appBar: AppBar(
                    ...
                    child: ListView.builder(
                      ...
                      :  Container(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          itemCount:
                          controller.sellAndBuyData.image?.length ?? 0,
                            ...
                            return Padding(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  width: Get.width * 0.8,
                                  imageUrl: controller
                                      .sellAndBuyData.image?[imageIndex] ??
                                      '',
